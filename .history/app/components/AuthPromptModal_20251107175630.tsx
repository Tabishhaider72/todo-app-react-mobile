...
export default function AuthPromptModal({ visible, onClose, message }: Props) {
    ...
    <Modal visible={visible} animationType="slide" transparent onRequestClose={onClose}>
      <View style={styles.backdrop}>
        <View style={styles.box}>
          ...
          <Text style={styles.message}>{message || 'You need to sign in to save tasks to cloud. Sign in now?'}</Text>

          <View style={styles.actions}>
            <TouchableOpacity style={styles.actionBtn} onPress={() => { onClose(); router.push('/(auth)/login'); }}>
              <Text style={styles.actionText}>Login</Text>
            </TouchableOpacity>

            <TouchableOpacity style={[styles.actionBtn, styles.secondary]} onPress={() => { onClose(); router.push('/(auth)/register'); }}>
